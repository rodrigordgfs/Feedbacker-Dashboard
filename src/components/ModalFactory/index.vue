  ...
  <teleport to='body'>
    ...
    >
      <div class='fixed mx-10' :class='state.width' @click.stop>
        <div
          class='flex flex-col overflow-hidden bg-white rounded-lg animate__animated animate__bounce animate__faster'
        >
...
const ModalLogin = defineAsyncComponent(() =>
  import('@/components/ModalLogin')
)

const ModalCreateAccount = defineAsyncComponent(() =>
  import('@/components/ModalCreateAccount')
)
